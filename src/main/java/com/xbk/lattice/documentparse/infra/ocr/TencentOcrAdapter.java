 ...
 * 腾讯 OCR 适配器
 *
 * 职责：承接腾讯 OCR 的 JSON Body 协议解析与探测能力
 *
 * @author xiexu
 */
@Component
public class TencentOcrAdapter extends AbstractJsonBodyOcrProviderAdapter {
     ...
     */
    public TencentOcrAdapter(
            RestClient.Builder restClientBuilder,
            ObjectMapper objectMapper,
            LlmSecretCryptoService llmSecretCryptoService
    ) {
        super(ProviderConnection.PROVIDER_TENCENT_OCR, restClientBuilder, objectMapper, llmSecretCryptoService);
    }
