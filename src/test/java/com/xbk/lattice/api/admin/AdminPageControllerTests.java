...
class AdminPageControllerTests {
    ...
    void shouldServeKnowledgePages() throws Exception {
        ...
        mockMvc.perform(get("/admin/index.html"))
                ...
                .andExpect(content().string(containsString("id=\"article-metadata\"")))
                ...
                .andExpect(content().string(not(containsString("id=\"refresh-hotspots\""))))
                .andExpect(content().string(not(containsString("id=\"hotspot-refresh-status\""))))
                .andExpect(content().string(not(containsString("热点刷新"))));
        ...
        mockMvc.perform(get("/admin/settings.html"))
                ...
                .andExpect(content().string(containsString("type=\"module\" src=\"/admin/settings-page.js?v=20260508-module-1\"")))
                .andExpect(content().string(containsString("href=\"/admin\"")))
                .andExpect(content().string(containsString("href=\"/admin/developer-access\"")))
    ...
    void shouldExposeArticlePresentationAssets() throws Exception {
        ...
        mockMvc.perform(get("/admin/modules/management-runtime-part-03.js"))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("data-resync-source")));

        mockMvc.perform(get("/admin/modules/management-runtime-part-04.js"))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(get("/admin/modules/management-runtime-part-05.js"))
                .andExpect(status().isOk())
