...
class AdminPageControllerTests {
    ...
    void shouldServeKnowledgePages() throws Exception {
        ...
        mockMvc.perform(get("/admin/index.html"))
                ...
                .andExpect(content().string(containsString("href=\"/admin/admin.css?v=20260506-article-toolbar-wrap-1\"")))
                .andExpect(content().string(containsString("type=\"module\" src=\"/admin/management.js?v=20260508-module-1\"")))
