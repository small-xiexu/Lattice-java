...
class AdminPageControllerTests {
    ...
    void shouldServeAdminPage() throws Exception {
        ...
        mockMvc.perform(get("/admin/index.html"))
                ...
                .andExpect(content().string(containsString("<option value=\"query\">query</option>")))
                .andExpect(content().string(containsString("<option value=\"answer\">answer</option>")))
                .andExpect(content().string(containsString("<option value=\"reviewer\">reviewer</option>")))
                .andExpect(content().string(containsString("<option value=\"rewrite\">rewrite</option>")))
                ...
                .andExpect(content().string(containsString("id=\"load-vector-config\"")))
                .andExpect(content().string(containsString("id=\"save-vector-config\"")))
                .andExpect(content().string(containsString("id=\"vector-config-enabled\"")))
                .andExpect(content().string(containsString("id=\"vector-config-profile-id\"")))
                .andExpect(content().string(containsString("id=\"vector-config-profile-dimensions\"")))
                .andExpect(content().string(containsString("id=\"vector-config-result\"")))
                .andExpect(content().string(containsString("id=\"refresh-vector-status\"")))
                .andExpect(content().string(containsString("id=\"rebuild-vector-index\"")))
                .andExpect(content().string(containsString("id=\"vector-status-view\"")))
                ...
                .andExpect(content().string(containsString("id=\"retrieval-config-parallel-enabled\"")))
                .andExpect(content().string(containsString("id=\"retrieval-config-rrf-k\"")))
                .andExpect(content().string(containsString("id=\"retrieval-config-result\"")))
